...
set CLASSPATH=%APP_HOME%\lib\ReefGuardian-1.0.0.jar

@rem FIX: Switch to assets folder so Gdx.files.internal() resolves correctly
cd /d "%APP_HOME%\assets"

@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" io.github.ReefGuardianProject.lwjgl3.GameLauncher %*
